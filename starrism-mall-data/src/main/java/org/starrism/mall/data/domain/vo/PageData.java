...
@Setter
@Getter
public class PageData<E> implements Pageable<E> {
    ...
    private PageData(List<E> records, Long total) {
    ...
    public PageData(Integer pageSize, Integer currPage, Long total, List<E> records) {
     ...
     * @since 2022/8/21
     */
    public static <E> PageData<E> of(List<E> records, Long total, BasePageDto dto) {
        return new PageData<>(dto.getPageSize(), dto.getCurrPage(), total, records);
    }
     ...
     * @since 2022/8/21
     */
    public static <E> PageData<E> of(List<E> records, Long total) {
